...
const ComprehensiveServicesSection: React.FC = () => {
  return (
    <section className="relative w-full bg-white py-3 md:py-16 lg:py-10 overflow-hidden font-sans">
      {/* Styles moved to index.css - see: animate-fade-up, scrolling-text-container-h2-alt, scrolling-text-inner-8s, delay-* */}

      {/* Background Decor */}
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-purple-100/25 rounded-full blur-3xl -z-10" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-pink-100/25 rounded-full blur-3xl -z-10" />

      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        {/* === HEADER SECTION === */}
        <div className="max-w-7xl animate-fade-up delay-100 mb-4 lg:mb-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6">
          ...
          <div className="md:col-span-3 bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden grid grid-cols-1 lg:grid-cols-2 animate-fade-up delay-200 group hover:border-purple-100 transition-colors">
            {/* Left Content */}
            <div className="p-6 lg:p-8 flex flex-col justify-center gap-4">
              ...
              <button className="w-fit px-5 py-2.5 bg-slate-900 text-white rounded-lg text-sm font-medium hover:bg-purple-600 transition-colors mt-1">
                See How It Works
              </button>
            </div>

            {/* Right Images (Collage Effect) */}
            <div className="relative bg-slate-50 min-h-[250px] lg:min-h-full overflow-hidden">
              {/* Decorative Circle */}
              ...
              {/* Image Grid */}
              <div className="absolute inset-3 grid grid-cols-2 gap-3 rotate-[-6deg] scale-110 origin-center opacity-90 group-hover:rotate-0 group-hover:scale-100 transition-all duration-700">
                <img
                ...
                <img
                  ...
                  className="rounded-xl shadow-md object-cover h-32 w-full mt-6"
                  alt="Meeting"
                />
                <img
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md border border-slate-100 flex flex-col justify-between h-[340px] animate-fade-up delay-300 relative overflow-hidden group">
            ...
            <div className="relative mt-6 bg-slate-50 rounded-lg p-3 border border-slate-100 group-hover:scale-105 transition-transform duration-500">
              <div className="flex justify-between items-end h-20 gap-1.5">
                ...
                <div className="w-full bg-pink-500 rounded-t-md h-[90%] relative">
                  <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-white shadow-md text-[9px] font-semibold px-1.5 py-0.5 rounded text-pink-600">
                    16.8k
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md border border-slate-100 flex flex-col justify-between h-[340px] animate-fade-up delay-300 relative overflow-hidden group">
            ...
            <div className="relative mt-5">
              <div className="bg-white shadow-md rounded-lg p-2.5 border border-slate-100 transform rotate-[-5deg] group-hover:rotate-0 transition-transform duration-500 absolute top-0 left-0 right-0 z-10">
                <div className="h-1.5 w-1/2 bg-slate-200 rounded mb-1.5"></div>
                <div className="h-1.5 w-3/4 bg-slate-100 rounded"></div>
              </div>
              <div className="bg-white shadow-sm rounded-lg p-2.5 border border-slate-100 transform rotate-[5deg] group-hover:rotate-0 transition-transform duration-500 absolute top-6 left-3 right-3 z-0 opacity-80">
          ...
          {/* 4. CTA CARD (Gradient) */}
          <div className="bg-gradient-to-br from-purple-600 to-pink-500 p-6 rounded-2xl shadow-lg flex flex-col justify-between h-[340px] animate-fade-up delay-300 relative overflow-hidden group">
            {/* Background shapes */}
            ...
            <div className="relative z-10 h-full flex flex-col justify-center">
              <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-tight mb-5">
                Join us now for <br />
                your business <br />
                growth!
              </h3>

              <button className="w-fit px-6 py-3 bg-white text-purple-700 rounded-lg font-semibold hover:bg-slate-50 transition-all flex items-center gap-2 text-sm md:text-base group-hover:gap-3">
