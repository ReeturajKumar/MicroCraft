...
const platformMenuData: {
  ...
  product: {
    ...
    items: [
      ...
      { title: "Security & Data Protection", href: "/platform/security-data-protection" },
      { title: "Mobile App", href: "/platform/mobile-app" },
    ],
  },
  teams: {
    title: "Teams",
    ...
    items: [
      { title: "Sales Teams", href: "/teams/sales" },
      { title: "Operations Teams", href: "/teams/operations" },
      { title: "Customer Support Teams", href: "/teams/customer-support" },
      { title: "Finance Teams", href: "/teams/finance" },
      { title: "Leadership Teams", href: "/teams/leadership" },
    ],
  },
  businessSize: {
    title: "Business Size",
    ...
    items: [
      { title: "Small Businesses", href: "/business-size/small-businesses" },
      { title: "Growing MSMEs", href: "/business-size/growing-msmes" },
      { title: "Multi-Branch Businesses", href: "/business-size/multi-branch" },
      { title: "Enterprises", href: "/business-size/enterprises" },
    ],
  },
};
