...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[120vh] sm:h-[100vh] md:h-[150vh] lg:h-[220vh] py-6 overflow-hidden bg-white antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
