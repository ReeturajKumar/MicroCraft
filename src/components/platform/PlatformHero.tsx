    ...
    return (
        <div className="w-full relative bg-white">
            ...
            <div className="relative z-10">
                ...
                <section className="max-w-8xl mx-auto px-8 lg:px-15 xl:px-16 pt-16 pb-16 md:pt-20 md:pb-20 grid grid-cols-1 lg:grid-cols-10 gap-12 items-center min-h-[85vh]">
                    ...
                    <div className="lg:col-span-7 flex flex-col items-start z-20 relative">
                        ...
                        >
                            ...
                            <span className="text-transparent bg-clip-text bg-linear-to-r from-[#7856FF] to-[#A855F7]">
                                In One Platform
                            </span>
                        </motion.h1>
                        ...
                        >
                            <div className="flex items-start gap-3 p-3.5 rounded-2xl bg-linear-to-br from-slate-50 to-white border border-slate-100 hover:border-purple-200 hover:shadow-md transition-all duration-300">
                                <div className="w-6 h-6 rounded-lg bg-linear-to-br from-purple-500 to-purple-600 flex items-center justify-center shrink-0 shadow-sm">
                    ...
                    <div className="lg:col-span-3 relative h-112.5 lg:h-125 w-full flex items-center justify-center lg:justify-end">
                        <div className="relative w-125 h-125">
                            ...
                            <motion.div 
                                ...
                                className="absolute -right-10 bottom-0 z-10 w-120 pointer-events-none"
                            >
                                <img 
                                    src={carImage} 
                            ...
                            <motion.div 
                                ...
                                className="absolute top-2 -left-16 bg-white p-4 rounded-3xl shadow-[0_20px_40px_-5px_rgba(0,0,0,0.08)] border border-slate-100 w-60 z-20 hover:shadow-lg transition-shadow"
                            >
                                ...
                                <div className="flex gap-4 h-20 items-end px-1 pb-1">
                                    <div className="w-1/2 h-full flex flex-col justify-end items-center gap-1 group">
                                        ...
                                        <div className="w-full h-[90%] bg-linear-to-b from-[#7856FF] to-[#6D28D9] rounded-t-xl relative shadow-sm"></div>
                                    </div>
                                    <div className="w-1/2 h-full flex flex-col justify-end items-center gap-1 group">
                            ...
                            <motion.div 
                                ...
                                className="absolute top-62.5 -left-32 bg-white/90 backdrop-blur-md p-6 rounded-[28px] shadow-[0_30px_60px_-10px_rgba(0,0,0,0.12)] border border-white/50 w-[320px] z-30"
                            >
                ...
                <section className="bg-[#0B0122] pt-32 pb-32 -mt-37.5 relative z-0">
                    {/* Seamless Background Stripes (Integrated) */}
                    <div className="absolute top-0 left-0 right-0 h-150 flex pointer-events-none overflow-hidden select-none">
                        <div className="flex-1 h-full bg-linear-to-b from-white via-[#FFF1EB] to-[#0B0122]"></div>
                        <div className="flex-1 h-full bg-linear-to-b from-white via-[#FFE4E1] to-[#0B0122]"></div>
                        <div className="flex-1 h-full bg-linear-to-b from-white via-[#FADADD] to-[#0B0122]"></div>
                        <div className="flex-1 h-full bg-linear-to-b from-white via-[#F5E1FD] to-[#0B0122]"></div>
                        <div className="flex-1 h-full bg-linear-to-b from-white via-[#E6E6FA] to-[#0B0122]"></div>
                        <div className="flex-1 h-full bg-linear-to-b from-white via-[#D8BFD8] to-[#0B0122]"></div>
                        <div className="flex-1 h-full bg-linear-to-b from-white via-[#C084FC] to-[#0B0122]"></div>
                        <div className="flex-1 h-full bg-linear-to-b from-white via-[#A855F7] to-[#0B0122]"></div>
                        <div className="flex-1 h-full bg-linear-to-b from-white via-[#8B5CF6] to-[#0B0122]"></div>
                        <div className="flex-1 h-full bg-linear-to-b from-white via-[#7C3AED] to-[#0B0122]"></div>
                    </div>

                    <div className="max-w-8xl mx-auto px-6 lg:px-12 xl:px-16 relative z-10 pt-48">
                        <div className="w-full border border-white/20 rounded-[40px] overflow-hidden bg-white/3 grid grid-cols-1 lg:grid-cols-2 backdrop-blur-xl shadow-[0_32px_64px_-15px_rgba(0,0,0,0.5)]">
                            {/* Graphic Side with Crisp Glass Background */}
                            <div className="p-6 md:p-8 lg:p-10 flex items-center justify-center bg-white/2 border-r border-white/20">
                                <div className="w-full aspect-4/3 rounded-[28px] bg-linear-to-br from-[#FFE8E0] via-[#FDC7C7] to-[#8E84F5] p-6 flex items-center justify-center relative shadow-2xl overflow-hidden">
                                    <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="w-full bg-white rounded-xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] p-6 z-10">
                                        ...
                                        <div className="relative h-40 w-full">
                                            ...
                                            <div className="absolute top-8 left-52.5 bg-white shadow-lg border border-slate-100 rounded-lg p-3 z-20 min-w-37.5">
                            ...
                            <div className="p-8 md:p-12 lg:py-14 lg:px-12 flex flex-col justify-center relative text-white bg-white/2 backdrop-blur-xl border-white/20">
                                <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="max-w-md">
                                    ...
                                    <div className="flex flex-wrap gap-6 mb-7">
                                        <div className="relative">
                                            ...
                                            <p className="text-slate-300 text-sm font-semibold leading-snug max-w-45">
