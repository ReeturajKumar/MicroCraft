      ...
      <div className="max-w-8xl mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 xl:gap-20">
          ...
          <div className="flex-1 max-w-2xl flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            >
              MicroCraft consolidates every branch, department, and transaction into a single source of truth. Transform raw data into automated growth strategies instantly.
            </motion.p>
            ...
            <div className="flex flex-col sm:flex-row gap-5 w-full">
               <motion.div 
                 ...
                 className="flex-1 bg-gradient-to-br from-[#7856FF] to-[#5D44CC] rounded-[24px] p-6 text-white relative overflow-hidden group h-[160px] shadow-lg shadow-purple-900/10"
               >
                  <div className="relative z-10 flex flex-col h-full justify-between items-start text-left">
                    <div>
                      <div className="text-[32px] font-black mb-1 leading-none tracking-tighter">15k+</div>
                      <p className="text-[11px] text-white/70 font-medium leading-tight max-w-[130px]">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex -space-x-2.5">
                         {[1, 2, 3].map((i) => (
                           <div key={i} className="w-8 h-8 rounded-full border-[2.5px] border-[#7856FF] overflow-hidden bg-slate-200 shadow-sm relative z-[30]">
                             <img src={`https://i.pravatar.cc/100?u=user${i}`} alt="user" className="w-full h-full object-cover" />
                           </div>
                         ))}
                      </div>
                      <span className="text-[11px] font-black text-white/90 tracking-wide uppercase">Scale Faster</span>
                    </div>
                  </div>
                  {/* Decorative mesh */}
               ...
               <motion.div 
                 ...
                 className="flex-1 bg-slate-50 rounded-[24px] p-6 relative overflow-hidden h-[160px] border border-slate-100 shadow-sm"
               >
                  <div className="relative z-10 flex flex-col items-start text-left">
                     <span className="inline-block px-2 py-0.5 bg-[#7856FF] rounded-[4px] text-white text-[9px] font-black uppercase tracking-wider mb-2">99.9% Accuracy</span>
                     <div className="text-[32px] font-black text-[#1A1A1A] leading-none mb-1 tracking-tighter">AI Focus</div>
                     <p className="text-[11px] text-slate-400 font-black uppercase tracking-widest leading-tight">Financial <br /> Forecasting & <br /> Real-time Audits</p>
                  </div>
                  {/* High-Fidelity Mobile Mockup */}
                  <div className="absolute right-[-10px] sm:right-[-20px] bottom-[-10px] sm:bottom-[-20px] w-[110px] sm:w-[130px] h-[120px] sm:h-[140px] transform rotate-[-5deg]">
                     <div className="w-full h-full bg-[#1A1A1A] rounded-t-[24px] sm:rounded-t-[36px] border-[4px] sm:border-[5px] border-slate-300 relative overflow-hidden shadow-2xl">
                        {/* Status Bar */}
          ...
          <div className="flex-1 w-full relative group lg:mt-0 mt-8">
            ...
            >
              {/* Main Browser Mockup */}
              <div className="bg-white rounded-[16px] md:rounded-[24px] overflow-hidden relative z-10 w-full xl:w-[115%] xl:-ml-[7.5%]">
                {/* Browser Header */}
                <div className="bg-[#F8FAFC] border-b border-slate-100 p-2 md:p-4 flex items-center justify-between">
                  ...
                  <div className="flex-1 max-w-[120px] sm:max-w-xs mx-4 md:mx-8">
                    <div className="bg-white rounded-md md:rounded-lg px-2 py-0.5 md:py-1 text-[8px] md:text-[10px] text-slate-400 flex items-center gap-1.5 md:gap-2">
                      <Shield className="w-2.5 h-2.5 md:w-3 md:h-3 text-[#7856FF]" /> <span className="truncate">dashboard.microcraft.ai</span>
                    </div>
                  </div>
