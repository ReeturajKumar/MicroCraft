...
const IntegrationsHero = () => {
  ...
  return (
    <section className="relative min-h-screen lg:min-h-145 flex items-center bg-transparent pt-32 lg:pt-20 pb-16 lg:pb-10 overflow-hidden font-sans">
      <div className="max-w-8xl mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-0">
          ...
          <div className="flex-1 max-w-2xl text-center lg:text-left lg:pt-8">
            ...
            >
              MicroCraft doesn't just connect; it synchronizes your data across
              100+ tools. Experience real-time workflows that eliminate manual
              entry and bridge department silos.
            </motion.p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
              {[
                {
                  icon: Zap,
                  text: "Zero-Latency Data Sync",
                  desc: "Instant updates across all apps",
                },
                {
                  icon: RefreshCw,
                  text: "Bidirectional Workflows",
                  desc: "Data flows both ways effortlessly",
                },
                {
                  icon: Layers,
                  text: "Centralized Governance",
                  desc: "Monitor all connections in one place",
                },
                {
                  icon: Check,
                  text: "Enterprise Security",
                  desc: "Soc2 & OAuth 2.0 implementation",
                },
              ].map((item, i) => (
                <motion.div
                ...
                >
                  ...
                  <div>
                    <h4 className="text-[14px] font-bold text-[#1A1A1A] mb-0.5">
                      {item.text}
                    </h4>
            ...
            >
              <button className="w-full sm:w-auto px-8 py-4 bg-[#7856FF] text-white rounded-2xl font-bold text-[16px] flex items-center justify-center gap-2 hover:bg-[#6339ff] transition-all shadow-xl shadow-purple-200/50 group">
                Explore Marketplace{" "}
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="w-full sm:w-auto px-8 py-4 bg-white text-slate-600 border border-slate-200 rounded-2xl font-bold text-[16px] hover:border-[#7856FF] hover:text-[#7856FF] transition-all">
                API Documentation
              </button>
            </motion.div>
            ...
            >
              ...
              <p className="text-[13px] text-slate-400 font-medium">
                Joined by{" "}
                <span className="text-[#1A1A1A] font-bold">2,500+</span> teams
                worldwide
              </p>
            </motion.div>
          </div>
          ...
          <div className="flex-1 w-full max-w-150 lg:max-w-none mx-auto lg:mx-0 relative mt-4 lg:mt-0">
            <div className="relative w-full h-112.5 sm:h-130 lg:h-120">
...
const SatelliteNode = ({
  ...
  >
    <div className="relative">
      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-[#F8FAFC] shadow-xl rounded-full absolute top-1 sm:top-1.25 left-0 ring-1 ring-slate-100" />
