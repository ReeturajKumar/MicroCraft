...
import img1 from "../../../assets/Financial1.webp";
import img2 from "../../../assets/Retirement.webp";
import img3 from "../../../assets/Freelance.webp";
import img4 from "../../../assets/Corporate.webp";
      ...
      <div className="max-w-8xl w-full mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-5">
            <h2 className="text-[32px] md:text-[42px] font-black text-[#1F1F1F] tracking-tight">
              Case study
            </h2>
