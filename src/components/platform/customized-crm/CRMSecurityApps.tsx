    ...
    <section className="w-full bg-white py-8 md:py-10 px-6 md:px-12 lg:px-20 overflow-hidden font-sans">
      <div className="max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center">
        ...
        <motion.div
          ...
          className="bg-white rounded-3xl border border-slate-100 p-5 md:p-8 flex flex-col items-center text-center overflow-hidden"
        >
          {/* Header Area */}
          ...
          <p className="text-[12px] md:text-[14px] text-slate-500 font-medium leading-relaxed max-w-sm mb-4">
            Embark on a transformative journey with our venture.{" "}
        ...
        <motion.div
          ...
          className="bg-white rounded-3xl border border-slate-100 p-4 md:p-6 flex flex-col items-center text-center relative overflow-hidden"
        >
          <div className="relative z-10 w-full flex flex-col items-center">
            ...
            <p className="text-[13px] md:text-[14px] text-slate-500 font-medium leading-relaxed mb-5 md:mb-6 max-w-md mx-auto">
              Built on trust. We adhere to rigorous industry standards to ensure
              your data remains protected and compliant globally.
            </p>
            ...
            <div className="w-full grid grid-cols-2 xs:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 gap-3 md:gap-4">
              ...
              <div className="bg-slate-50/50 border border-slate-100 rounded-xl py-2.5 px-3 flex flex-col items-center justify-center transition-all hover:bg-white hover:shadow-md group">
                <div className="w-7 h-7 md:w-8 md:h-8 mb-1 text-slate-900 transition-transform group-hover:scale-110">
                  ...
                  >
                    <path
                      d="M12 2L3 7V12C3 17.5 7.1 21.3 12 22C16.9 21.3 21 17.5 21 12V7L12 2Z"
                ...
                <p className="text-[8px] md:text-[9px] font-black text-slate-900 uppercase tracking-widest leading-none">
                  ISO 27001
                </p>
              </div>
              ...
              <div className="bg-slate-50/50 border border-slate-100 rounded-xl py-2.5 px-3 flex flex-col items-center justify-center transition-all hover:bg-white hover:shadow-md group font-sans">
                <div className="text-lg md:text-xl font-black text-slate-900 tracking-tighter mb-0.5 italics">
                  CCPA
                </div>
                <div className="text-[#059669] text-[7px] md:text-[8px] font-black tracking-wider uppercase bg-emerald-50 px-2 py-0.5 rounded">
                  COMPLIANT
                </div>
              </div>
              ...
              {/* GDPR */}
              <div className="bg-slate-50/50 border border-slate-100 rounded-xl py-2.5 px-3 flex flex-col items-center justify-center transition-all hover:bg-white hover:shadow-md group font-sans">
                <div className="text-lg md:text-xl font-black text-slate-900 tracking-tight mb-0.5 leading-none">
                  GDPR
                </div>
                <div className="text-[#2563EB] text-[7px] md:text-[8px] font-black tracking-wider uppercase bg-blue-50 px-2 py-0.5 rounded">
                  PROTECTED
                </div>
              </div>
              ...
              <div className="bg-slate-50/50 border border-slate-100 rounded-xl py-2.5 px-3 flex items-center justify-center gap-2 transition-all hover:bg-white hover:shadow-md group">
                <div className="w-7 h-7 rounded bg-indigo-600 flex items-center justify-center text-[8px] font-black text-white shadow-lg shadow-indigo-200">
                  9001
                </div>
                <p className="text-[8px] md:text-[9px] font-black text-slate-900 uppercase tracking-widest leading-none">
                  ISO 9001
...
const LogoCard = ({ image, empty }: { image?: string; empty?: boolean }) => (
  <div
    className={`w-10 h-10 md:w-14 md:h-14 rounded-[10px] md:rounded-[14px] flex items-center justify-center transition-all duration-500 ${empty ? "bg-slate-400/30" : "bg-white shadow-[0_8px_12px_rgba(0,0,0,0.08)] border border-slate-50 group-hover:shadow-[0_8px_20px_rgba(0,0,0,0.08)]"}`}
  >
    {!empty && image && (
      <img
        src={image}
