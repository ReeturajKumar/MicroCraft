  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        {/* Logistics Flow Visualization */}
        <div className="bg-white rounded-lg border-2 border-slate-200 p-2.5 lg:p-3 shadow-lg mb-4">
          <h3 className="text-xs md:text-sm font-bold text-slate-900 mb-2.5 text-center">
            Logistics Flow
          </h3>
            ...
            {logisticsFlow.map((step, idx) => {
              ...
              return (
                ...
                >
                  {/* Step Card */}
                  <div
                    className={`bg-gradient-to-br ${step.color} rounded-lg p-2 text-white shadow-md group hover:scale-105 transition-transform duration-300 w-full max-w-[100px]`}
                    style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {features.map((feature, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white border-2 border-slate-200 rounded-lg p-3 hover:border-purple-300 hover:shadow-lg transition-all duration-300 group relative overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-between mb-2.5">
                    <div
                      className={`w-8 h-8 rounded-lg bg-gradient-to-br ${feature.gradient} flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform`}
                    >
                      <Icon size={16} />
                    </div>
                  ...
                  <h4 className="text-xs font-bold text-slate-900 mb-1.5 group-hover:text-purple-700 transition-colors">
                    {feature.title}
                  </h4>
