            ...
            <div className="bg-white rounded-xl border-2 border-slate-200 p-4 lg:p-5 shadow-lg sticky top-4">
              ...
              <div className="mt-5 pt-4 border-t border-slate-200">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-[10px] font-bold text-green-600">88%</span>
                </div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-2">
                <div className="bg-slate-50 rounded-lg p-2 border border-slate-200">
                  <div className="text-base font-bold text-slate-900">-15%</div>
                  <div className="text-[9px] text-slate-600">Table Turn Time</div>
                </div>
                <div className="bg-slate-50 rounded-lg p-2 border border-slate-200">
                  <div className="text-base font-bold text-slate-900">+22%</div>
                  <div className="text-[9px] text-slate-600">Repeat Visits</div>
                </div>
              </div>
            </div>
          </div>
