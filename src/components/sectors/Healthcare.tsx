            ...
            <div className="bg-white rounded-lg sm:rounded-xl border-2 border-slate-200 p-3 sm:p-4 md:p-5 lg:p-5 shadow-lg sticky top-4">
              ...
              <div className="mt-4 sm:mt-5 pt-3 sm:pt-4 border-t border-slate-200">
                <div className="flex items-center justify-between mb-1.5 sm:mb-2">
                  ...
                  <span className="text-[9px] sm:text-[10px] font-bold text-green-600">95%</span>
                </div>
              ...
              <div className="mt-3 sm:mt-4 grid grid-cols-2 gap-2">
                <div className="bg-slate-50 rounded-lg p-1.5 sm:p-2 border border-slate-200">
                  <div className="text-sm sm:text-base font-bold text-slate-900">50%</div>
                  <div className="text-[8px] sm:text-[9px] text-slate-600">Time Saved</div>
                </div>
                <div className="bg-slate-50 rounded-lg p-1.5 sm:p-2 border border-slate-200">
                  <div className="text-sm sm:text-base font-bold text-slate-900">100%</div>
                  <div className="text-[8px] sm:text-[9px] text-slate-600">Compliance</div>
                </div>
              </div>
            </div>
          </div>
