      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-2.5">
            {steps.map((step, idx) => (
              ...
              >
                ...
                <div className="flex items-center justify-between pl-2.5 relative z-10">
          ...
          <div className="lg:col-span-7 h-full min-h-[450px] relative">
            {/* Dashboard Container */}
            <div className="absolute inset-0 bg-white rounded-3xl border border-slate-200/50 shadow-xl hover:shadow-2xl hover:shadow-purple-500/10 overflow-hidden flex flex-col items-center justify-center p-6 text-center group">
              {/* 1. Dynamic Detail Content */}
              <div className="mb-10 max-w-md mx-auto relative z-10">
                <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-md bg-slate-100 text-slate-500 text-[9px] font-bold mb-4 uppercase tracking-widest border border-slate-200">
                  <span className="w-1.5 h-1.5 rounded-full bg-purple-500 animate-pulse"></span>
                  Process: Step {activeStep + 1}/5
                </div>
                <h3 className="text-2xl md:text-3xl font-bold text-slate-900 mb-2 transition-all duration-500">
                  {steps[activeStep].title}
                </h3>
                <p className="text-slate-600 leading-relaxed text-sm transition-all duration-500">
                  {steps[activeStep].detail}
                </p>
              </div>

              {/* 2. Central Visualization */}
              <div className="relative w-full max-w-lg h-40 flex items-center justify-between z-10">
                {/* NODE A: Your Store */}
                <div className="flex flex-col items-center gap-2.5">
                  <div className="w-16 h-16 bg-white rounded-xl flex items-center justify-center shadow-lg border border-slate-200/50 relative group-hover:-translate-y-1 transition-transform duration-500">
                ...
                <div className="flex-1 h-0.5 bg-slate-100 relative mx-5">
                  {/* Flowing Dash */}
                  ...
                  {/* Data Packet */}
                  <div className="absolute top-1/2 -translate-y-1/2 w-3 h-3 bg-white border-2 border-purple-500 rounded-full shadow-md z-20 flex items-center justify-center animate-[slide-right_2s_linear_infinite]">
                ...
                {/* NODE B: ONDC Cloud */}
                <div className="flex flex-col items-center gap-2.5">
                  <div className="w-20 h-20 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full flex items-center justify-center shadow-xl shadow-purple-600/30 relative">
                    {/* Pulse Rings */}
                    ...
                    <Globe size={32} className="text-white relative z-10" />
                  </div>
              ...
              >
                ...
                <div className="flex flex-wrap justify-center gap-2.5">
                  {buyerApps.map((app, i) => (
                    <span
                      key={app.name}
                      className={`px-3 py-1.5 rounded-lg text-xs font-bold shadow-md transform transition-all duration-500 hover:-translate-y-0.5 cursor-default ${app.color}`}
