...
const Analytics = () => {
    ...
    return (_jsxs("div", { onMouseMove: handleMouseMove, className: "relative w-full min-h-screen bg-slate-50 overflow-hidden", children: [_jsxs("div", { className: "relative z-10", children: [_jsx(AnalyticsSection, {}), _jsx(FeaturesSection, {}), _jsx(IntegrationsSection, {}), _jsx(Testimonial, {})] }), _jsxs("div", { className: "pointer-events-none absolute inset-0 z-20 overflow-hidden", children: [_jsx("div", { className: "absolute top-0 right-0 w-[800px] h-[800px] bg-purple-200/20 rounded-full blur-[120px] mix-blend-multiply" }), _jsx("div", { className: "absolute bottom-0 left-0 w-[600px] h-[600px] bg-blue-200/20 rounded-full blur-[120px] mix-blend-multiply" }), _jsx("div", { className: "absolute inset-0", style: {
                            backgroundImage: `
