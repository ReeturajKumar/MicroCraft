...
import { ChevronRight, CheckCircle2, TrendingUp, Target, Users, Zap, BarChart3, MessageCircle } from "lucide-react";
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-8 max-w-7xl relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-slate-900 leading-tight mb-6">
                Built for
                <span className="bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-400 text-transparent bg-clip-text block mt-2">
                  Sales Teams
                </span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 leading-relaxed mb-8">
                Everything your sales team needs to close more deals, faster. CRM, pipeline management, automation, and analytics designed for sales professionals.
              </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-8 max-w-7xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                Tools designed to help your sales team win
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {[
                { icon: Target, title: "Pipeline Management", desc: "Visual pipeline to track deals from lead to close" },
                { icon: TrendingUp, title: "Sales Forecasting", desc: "Accurate revenue predictions based on real data" },
                { icon: Users, title: "Lead Management", desc: "Never miss a lead with automated capture and routing" },
                { icon: Zap, title: "Auto Follow-Ups", desc: "Automated reminders and follow-up sequences" },
                { icon: MessageCircle, title: "Communication Hub", desc: "All customer communications in one place" },
                { icon: BarChart3, title: "Sales Analytics", desc: "Track performance, quotas, and team metrics" },
              ].map((feature, idx) => (
                <div
                  key={idx}
                  className="p-6 bg-slate-50 rounded-xl hover:bg-white hover:shadow-lg transition-all border border-slate-200 hover:border-purple-300"
                >
        ...
        <section className="py-16 md:py-24 bg-gradient-to-br from-purple-50 to-pink-50">
          <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-8 max-w-7xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { title: "Close More Deals", desc: "Better pipeline visibility leads to higher conversion rates" },
                { title: "Save Time", desc: "Automation frees up time for selling, not admin work" },
                { title: "Data-Driven Selling", desc: "Make decisions based on real sales data and insights" },
              ].map((benefit, idx) => (
